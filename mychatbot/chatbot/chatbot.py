...
def handle_user_input(chats,user,user_input, collection):
    ...
    prompt="You are a medical educational assistant.Provide accurate and easy-to-understand medical informationUsing this data:"+str(data)+".Remember to advise users to consult with healthcare professionals for medical advice." #提示詞
    messages.append({
